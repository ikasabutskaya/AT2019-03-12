package by.it.medvedeva.at01_06;
 ...
 */
    ...
    private static Test_at06 run(String in) {
        return run(in, true);
    }

    private static Test_at06 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at06(clName, in, runMain);
    }
    ...
    private Test_at06(String className, String in, boolean runMain) {
