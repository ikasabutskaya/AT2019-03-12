package by.it.medvedeva.at01_04;
...
public class Test_at01_04 {
    ...
    public void testTaskA3_run_main__TaskA() throws Exception {
        Test_at01_04 ok = run("123 99 88 77 66 5 4 3 1 0 2");
        ok
                .include("2*2=4  2*3=6  2*4=8  2*5=10 2*6=12 2*7=14 2*8=16 2*9=18")
                .include("3*2=6  3*3=9  3*4=12 3*5=15 3*6=18 3*7=21 3*8=24 3*9=27")
                .include("4*2=8  4*3=12 4*4=16 4*5=20 4*6=24 4*7=28 4*8=32 4*9=36")
 ...
 */
    ...
    private static Test_at01_04 run(String in) {
        return run(in, true);
    }

    private static Test_at01_04 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at01_04(clName, in, runMain);
    }
    ...
    private Test_at01_04(String className, String in, boolean runMain) {
