...
public class Test_at01_02 {
    ...
    public void testTaskC() throws Exception {
        ...
        Test_at01_02 ok = run("5").include("-5").include("5");
 ...
 */
    ...
    private static Test_at01_02 run(String in) {
        return run(in, true);
    }

    private static Test_at01_02 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at01_02(clName, in, runMain);
    }
    ...
    private Test_at01_02(String className, String in, boolean runMain) {
