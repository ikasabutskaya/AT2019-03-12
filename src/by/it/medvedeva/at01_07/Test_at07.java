package by.it.medvedeva.at01_07;
 ...
 */
    ...
    private static Test_at07 run(String in) {
        return run(in, true);
    }

    private static Test_at07 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at07(clName, in, runMain);
    }
    ...
    private Test_at07(String className, String in, boolean runMain) {
