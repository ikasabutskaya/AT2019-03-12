package by.it.medvedeva.at01_03;
...
public class Test_at01_03 {

    @Test(timeout = 5000)
    public void testTaskA1__InOut() throws Exception {
        Test_at01_03 ok = run("", false);
 ...
 */
    ...
    private static Test_at01_03 run(String in) {
        return run(in, true);
    }

    private static Test_at01_03 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at01_03(clName, in, runMain);
    }
    ...
    private Test_at01_03(String className, String in, boolean runMain) {
