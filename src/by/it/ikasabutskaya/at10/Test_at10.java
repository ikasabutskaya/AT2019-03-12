package by.it.ikasabutskaya.at10;
...
public class Test_at10 {
    ...
    private static Test_at10 run(String in) {
        return run(in, true);
    }

    private static Test_at10 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at10(clName, in, runMain);
    }
    ...
    private Test_at10(String className, String in, boolean runMain) {
