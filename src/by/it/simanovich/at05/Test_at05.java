...
public class Test_at05 {
    ...
    public void testTaskC2() throws Exception {
        ...
        String s1 = (String) mSlow.invoke(null, by.it.simanovich.at05.Poem.text);
        long dtSlow = (System.nanoTime() - t) / 1000;
        System.out.println("slow dt=" + dtSlow);

        t = System.nanoTime();
        String s2 = (String) mFast.invoke(null, by.it.simanovich.at05.Poem.text);
        ...
        String[] word = by.it.simanovich.at05.Poem.text.split("[^а-яА-ЯёЁ]+");
        for (int i = 0; i < 10; i++) {
 ...
 */
    ...
    private static Test_at05 run(String in) {
        return run(in, true);
    }

    private static Test_at05 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at05(clName, in, runMain);
    }
    ...
    private Test_at05(String className, String in, boolean runMain) {
