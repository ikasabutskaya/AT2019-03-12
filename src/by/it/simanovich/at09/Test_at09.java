 ...
 */
    ...
    private static Test_at09 run(String in) {
        return run(in, true);
    }

    private static Test_at09 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at09(clName, in, runMain);
    }
    ...
    private Test_at09(String className, String in, boolean runMain) {
