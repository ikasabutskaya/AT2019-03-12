...
public class User {
    ...
    public User(int id, String new_login, String new_password, String new_email, java.util.Date date) {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (email != null ? !email.equals(user.email) :
                user.email != null) return false;
        return date != null ? date.equals(user.date) :
                user.date == null;
    }
