...
public class TaskA2 {
    public static void main(String[] args) {
        //это не полноценный лист, а массив на интерфейсе
        List<Integer> integersA = Arrays.asList(1, 2, 2,2,2,2, 4, 5, 6, 7);
        List<Integer> integersB = Arrays.asList(10, 4, 5, 6, 7,7,7,7,8,9,10);
