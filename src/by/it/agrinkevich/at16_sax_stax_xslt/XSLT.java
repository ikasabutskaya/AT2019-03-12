...
public class XSLT {
    public static void main(String[] args) throws TransformerException, IOException {
        String xslPath = "src/by/it/agrinkevich/at16_sax_stax_xslt/rules.xsl";
        String xmlPath = "src/by/it/agrinkevich/at15/sites.xml";
        String htmlPath = "src/by/it/agrinkevich/at16_sax_stax_xslt/result.html";
